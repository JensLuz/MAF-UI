var Template = new MAF.Class({
	...
	createView: function () {
		...
		var topButton = view.elements.topButton = new MAF.control.TextButton({
			...
			events: {
				onSelect: function() {
					var statusText = view.createTextblock(100,900,1800,20,"",18,"white",view.elements.topContainer);
					var statusText2 = view.createTextblock(100,920,1800,20,"",18,"white",view.elements.topContainer);
					var statusText3 = view.createTextblock(100,940,1800,20,"",18,"white",view.elements.topContainer);
					...
					oauthRequest.onreadystatechange = function() {
						if (oauthRequest.readyState===4 && oauthRequest.status === 200) {
							...
							statusText2.setText('Authorization: bearer ' + tokenObject.access_token);
							...
							apiRequest.onreadystatechange = function() { 
								...
								if (apiRequest.readyState===4 && apiRequest.status === 200) {
									statusText3.setText("You are customer: " + apiRequest.responseText);
								}
							}
							apiRequest.send();
						}
